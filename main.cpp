...
int main()
{
	...
	//-----------------------------------------------------------------------------------------------------------
	// Test 1 : verifichiamo che tutti i markers siano salvati correttamente
	cout << "TEST 1"<<endl;
	...
	//-----------------------------------------------------------------------------------------------------------
	// Test 2 : verifichiamo che i segmenti non abbiamo dimensione nulla
	cout << "--------------------------------------------------------"<<endl;
	cout << "TEST 2:"<< endl;
	int flag = 0;
	...
	//-------------------------------------------------------------------------------------------------------------
	// Test 3 : verifichiamo che ogni poligono abbia area non nulla 
	// per farlo usiamo un algoritmo visto nella prima lezione di geometria computazionale
	cout << "--------------------------------------------------------"<<endl;
	cout << "TEST 3:"<< endl;
